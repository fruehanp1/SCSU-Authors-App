...
To download the data from Zotero for the first time run:
...
To update the data from Zotero after adding new resources run:
...
If you want to change the facets for the search they can be found at the bottom of Composer.py.

If you need to change the API key or Zotero group link they can be found in main.py.

Kerko comes with a very in-depth README already as you can see below, you shouldn't need anymore information than is included above though.
