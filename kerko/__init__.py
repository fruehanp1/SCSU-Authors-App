...
def init_default_config(state):
    ...
    - `KERKO_WITH_POPPER`
    """
    state.app.config.setdefault('KERKO_TITLE', "SCSU")
    ...
    state.app.config.setdefault('KERKO_FACET_COLLAPSING', True)
    state.app.config.setdefault('KERKO_FULLTEXT_SEARCH', True)
    state.app.config.setdefault('KERKO_PRINT_ITEM_LINK', False)
    state.app.config.setdefault('KERKO_PRINT_CITATIONS_LINK', True)
    ...
    state.app.config.setdefault('KERKO_TEMPLATE_LANDING', 'kerko/landing.html.jinja2')
    state.app.config.setdefault('KERKO_TEMPLATE_SCOPUSPULL', 'kerko/autoupdate.html.jinja2')
